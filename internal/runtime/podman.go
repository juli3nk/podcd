...
func (d *PodmanRuntime) Run(spec RunSpec) error {
	args := []string{"run"}
...
func (d *PodmanRuntime) CreateVolume(v model.Volume) error {
...
func (d *PodmanRuntime) CreateNetwork(n model.Network) error {
