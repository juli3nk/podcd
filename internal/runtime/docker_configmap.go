...
func (r *DockerRuntime) ListConfigMaps(filter Labels) ([]ConfigMapInfo, error) {
...
func (r *DockerRuntime) CreateConfigMap(configMap model.ConfigMap, hash string) error {
...
func (r *DockerRuntime) RemoveConfigMap(name string) error {
...
func (r *DockerRuntime) loadConfigMapLabels(configMapFilename string) (Labels, error) {
